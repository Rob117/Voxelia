...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class DepthOfField : PostEffectsBase {
        ...
        public LayerMask layerToIgnore; // PRODUCTION - make sure when instantiating players from other servers to use a layer that IS NOT THIS
        private bool focalPointAssigned;
        ...
        void Refocus() {
            ...
            if (Physics.Raycast(ray, out hit, 1000, layerToIgnore.value) && hit.point != focalPoint) {
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination) {
            ...
            focalDistance01 = (focalPointAssigned) ? (cachedCamera.WorldToViewportPoint (focalPoint)).z / (cachedCamera.farClipPlane) : FocalDistance01 (focalLength);
